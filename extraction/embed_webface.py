"""Extract CASIA-WebFace embeddings -> embeddings/webface/<model>.npy (+ metadata).

The paper uses 5 images/identity (--max-images-per-id 5). Set HF_TOKEN for the face models.
"""
import os
import argparse
import numpy as np
